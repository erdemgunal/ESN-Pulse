...
In this updated `README.md`, I have added a **Reports** section where the images are displayed using relative paths (`./docs/filename.png`). These paths assume the images are stored in the `/docs` folder as you mentioned.
